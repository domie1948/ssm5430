<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="防护标题" prop="fanghubiaoti">
          <el-input v-model="ruleForm.fanghubiaoti" 
              placeholder="防护标题" clearable  :readonly="ro.fanghubiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="防护标题" prop="fanghubiaoti">
              <el-input v-model="ruleForm.fanghubiaoti" 
                placeholder="防护标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
            ...
            ruleForm: {
                	        fanghubiaoti: '',
	                        	        ...
	                        	        neirongxiangqing: '',
                                                                                                ...
                                                                                                rules: {
                  fanghubiaoti: [
                            { required: true, message: '防护标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  leixing: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='fanghubiaoti'){
            this.ruleForm.fanghubiaoti = obj[o];
	    this.ro.fanghubiaoti = true;
            continue;
          }
	            	            if(o=='leixing'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yiqingfanghu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiqingfanghuCrossAddOrUpdateFlag = false;
                  this.parent.search();
